...
echocolor "Configuring hostname for HOST_NSDB1 node"
sleep 3
echo "$HOST_NSDB1" > /etc/hostname
...
touch $iphost
cat << EOF >> $iphost
127.0.0.1       localhost $HOST_NSDB1
